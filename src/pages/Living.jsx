...
const text = {
  ...
  less: [
    'Consider a comfortable and stylish sofa set as the focal point. Options like sectional sofas or a classic three-seater with coordinating chairs can work well.',
